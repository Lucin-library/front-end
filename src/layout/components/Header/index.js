        ...
        <header className={cx('wrapper')}>
            ...
            <section className={cx('categories')}>
                <div class="container" className={cx('navigation')}>
                    <div class="nav-option" onClick={() => navigate('/')}>
                        <a>Trang chủ</a>
                    </div>
                    <Dropdown title="Thể loại" elements={array1} />
                    <Dropdown title="Văn học" elements={array2} />
                    <Dropdown title="Khoa học - Công nghệ" elements={array3} />
                </div>
            </section>
        </header>
    );
