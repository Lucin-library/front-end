...
const scores = [
    { color: '#d01937', score: 1, icon: '▲' },
    { color: '#7c46b0', score: 1, icon: '◆' },
    { color: '#c79200', score: 0, icon: '■' },
    { color: '#237e0b', score: 2, icon: '✔', correct: true },
];
                    ...
                    {scores.map((score, index) => (
                        <div key={index} style={{ ...styles.scoreItem }}>
                            ...
                            <div
                                style={
                                    (styles.scoreIcon,
                                    { backgroundColor: score.color, width: '100%', padding: '0px 10px' })
                                }
                            >
                                {score.icon}
                            </div>
